			...
			<div class="row">
				...
				<div class="col s6">
					<div class="card-panel #e53935 red darken-1">
  					...
  					<div class="card-panel #e53935 red darken-1">
  						 <!-- Modal Trigger -->
  						<a class="waves-effect waves-light btn-large modal-trigger #e53935 red darken-1" href="#modal1"><i class="material-icons right">equalizer</i>PROGRESO POR ALUMNOS</a>
  					</div>
